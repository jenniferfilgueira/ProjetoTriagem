...
Além disso, o sistema busca proporcionar uma primeira avaliação remota, reduzindo a necessidade de deslocamento imediato ao hospital para casos simples.
...
- Demora no atendimento, especialmente quando médicos estão ocupados com outros pacientes.
Ao chegar no hospital, o paciente frequentemente enfrenta longos períodos de espera até que o atendimento seja iniciado, o que impacta diretamente na experiência e eficiência do serviço de saúde.
...
- Otimização do fluxo hospitalar, diminuindo filas e tempo de espera.
Com isso, o sistema contribui para uma melhor organização do atendimento, maior agilidade e uso mais eficiente dos recursos hospitalares.
...
```bash
git clone https://github.com/jenniferfilgueira/SistemaTriagemHospitalar.git
